...
- **CI/CD**: every PR runs the quality gate; release-please derives
  versions from the commit history; the `release` workflow publishes the
  image to Docker Hub with semver tags.
